...
describe("propwise analysis engine", () => {
  it("returns transparent value, scores, classification, and future projections", async () => {
    const result = await appRouter.createCaller(ctx).ml.predict({
      title: "Test plot", address: "Bengaluru", latitude: 12.97, longitude: 77.59,
      areaSqft: 1200, propertyType: "Residential plot", category: "residential",
      roadAccess: "Paved road", amenities: ["School", "Hospital"],
    });
